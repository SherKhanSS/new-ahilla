...
const isDesktop = document.documentElement.clientWidth > CLIENT_WIDTH;
          ...
          <ul className="main-nav__list site-list">
            ...
            <li
              onMouseEnter={
                isDesktop
                  ? () => {
                    subMenuClosed ? setSubMenuClosed(!subMenuClosed) : null;
                  }
                  : null
              }
              onMouseLeave={
                isDesktop
                  ? () => {
                    subMenuClosed ? null : setSubMenuClosed(!subMenuClosed);
                  }
                  : null
              }
